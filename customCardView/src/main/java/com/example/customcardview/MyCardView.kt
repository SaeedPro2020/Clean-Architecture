...
class MyCardView: CardView {
    ...
    private var normalCardElevation = 5f
    private var pressedCardElevation = 10f
    private var cardPressedColor = cardBackgroundColor.defaultColor
    private var isAnimationEnabled = true
    private var clickDelay = 150
